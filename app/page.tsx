  ...
  return (
    <>
      <div className="relative min-h-screen overflow-hidden pt-8 before:absolute before:inset-0 before:-z-1 before:h-full before:bg-[url('/assets/img/ic_bg_sales_sec.png')] before:bg-cover before:bg-center before:bg-no-repeat before:content-[''] md:pt-[60px]">
        ...
        <section
          id="home"
          className="m-auto max-w-[848px] px-8 pt-8 text-center md:px-0 md:pt-[60px]"
        >
            ...
            <div className="flex flex-col gap-0 md:gap-20">
              ...
              <div className="relative flex hidden justify-center lg:block">
                <Image
                  ...
                  className="relative z-1 w-[120%] max-w-[120%]"
                />
              </div>
            </div>
      ...
      <section className="flex flex-col gap-15 overflow-hidden bg-white py-15 lg:gap-20 lg:py-32">
        <div
          id="howitworks"
          className="m-auto max-w-[768px] px-8 text-center lg:px-0"
        >
        ...
        <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
          ...
          <div className="relative lg:mt-0">
            <div className="mr-auto w-full">
              <div className="flex flex-col gap-12 rounded-[0px] border border-[#2DA9DF80] bg-[#F3F8FC] p-0 opacity-100 shadow-[0px_0px_30px_0px_#2DA9DF1A] sm:p-12 lg:rounded-l-3xl">
                <Image
        ...
        <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
          <div className="relative order-2 lg:order-1 lg:mt-0">
            <div className="flex flex-col gap-12 rounded-[0px] border border-[#2DA9DF80] bg-[#F3F8FC] p-0 opacity-100 shadow-[0px_0px_30px_0px_#2DA9DF1A] sm:p-12 lg:rounded-r-3xl">
              <Image
      ...
      <section
        id="testimonials"
        className="flex flex-col gap-[20px] px-6 pt-10 pb-20 md:p-20"
      >
        <div className="m-auto max-w-[768px] text-center">
          <span className="text-sm leading-[20px] font-semibold text-[#1375BC] md:text-base">
            Testimonials
